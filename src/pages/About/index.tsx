    ...
    <>
      ...
      <div className="max-w-[1170px] mx-auto my-[50px] flex flex-col gap-12">
        <div className="flex justify-center items-center gap-8 flex-wrap">
          ...
          <img src="http://192.168.1.169:8080/img/about/about_1.jpg" className="w-[25%] max-med:w-[70%] h-full rounded-lg" alt="" />
        </div>
        <div className="flex justify-center items-center gap-8 flex-wrap">
          <img src="http://192.168.1.169:8080/img/about/about_2.jpg" className="w-[25%] max-med:w-[70%] h-full rounded-lg" alt="" />
          <div className="flex flex-col w-1/2 max-med:w-full mx-4">
            <div className="flex flex-col text-[36px] font-bold">
        ...
        <div className="flex justify-center items-center flex-col gap-8">
          ...
          <img src="http://192.168.1.169:8080/img/about/about_3.jpg" className="w-[25%] max-med:w-[70%] h-full rounded-lg" alt="" />
        </div>
      </div>
    </>
  )
