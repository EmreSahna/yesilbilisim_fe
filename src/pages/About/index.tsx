    ...
    <>
      ...
      <div className="max-w-[1170px] mx-auto flex flex-col my-[50px]">
        <div className="my-[50px]">
          <h2 className="font-bold text-main-blue text-[32px] max-small:text-center">Yeşilbilişim<span className="text-main-black"> Hakkında</span></h2>
        ...
        <div className="my-[50px]">
          <h2 className="font-bold text-main-black text-[32px] text-right max-small:text-center">Kaliteli Hizmet Sunma Sözü<span className="text-main-blue"> Yeşilbilişim</span>'de</h2>
          <div className="my-[10px] text-justify max-small:px-4">
        ...
        <div className="my-[50px]">
          <h2 className="font-bold text-main-black text-[32px] max-small:text-center">Mükemmel Hizmet <span className="text-main-blue">Vizyonu</span></h2>
          <div className="my-[10px] text-justify max-small:px-4">
            <img src="http://localhost:8080/img/about/about_3.jpg" className="w-[30%] max-small:w-[60%] float-right ml-4" alt="about" />
        ...
        <div className="justify-center flex items-center my-[50px] gap-[30px] max-small:gap-[15px]">
          <div className="flex flex-col text-[32px] font-semibold max-small:text-[20px]">
            <h3 className="pr-6 text-main-black">Etkin Çözümler</h3>
            <h3 className="pl-6 text-main-blue">Başarılı Sonuçlar</h3>
          </div>
          <hr className="border-2 border-main-gray-3 h-[140px] max-small:h-[80px]" />
          <img src="http://localhost:8080/img/logo/logo.png" alt="logo" className="w-[30%] max-small:w-[40%] h-full" />
        </div>
      </div>
    </>
  )
