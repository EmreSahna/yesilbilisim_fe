        ...
        <div className="bg-main-blue grid grid-cols-2 gap-x-10 px-16 py-12">
            ...
            <div className="col-span-1 bg-white shadow-md rounded-xl px-8 py-10 mb-4">
                <div className="flex justify-center">
                    <i className="material-icons text-main-blue text-[80px]">check_circle</i>
                </div>
                ...
                <button className="flex items-center bg-main-black text-white py-2 px-6 rounded-xl mt-8" type="button" onClick={() => setSubmitted(false)}>
